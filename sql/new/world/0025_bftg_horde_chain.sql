...
SET @OGUID:= 164445; -- 13 GUIDs required
...
UPDATE `creature_questender` SET `id`=31412 WHERE `id`=32363 AND `quest`=13257;
DELETE FROM `creature` WHERE phasemask = 128 and map = 1;
DELETE FROM `gameobject` WHERE phasemask = 128 and map = 1;