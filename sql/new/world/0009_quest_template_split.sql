ALTER TABLE `quest_template`
	CHANGE COLUMN `Level` `QuestLevel` SMALLINT(3) NOT NULL DEFAULT '1' AFTER `Method`,
	CHANGE COLUMN `ZoneOrSort` `QuestSortID` SMALLINT(6) NOT NULL DEFAULT '0' AFTER `MaxLevel`,
	CHANGE COLUMN `Type` `QuestType` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `QuestSortID`,
	CHANGE COLUMN `SuggestedPlayers` `SuggestedGroupNum` TINYINT(3) UNSIGNED NOT NULL DEFAULT '0' AFTER `QuestType`,
	CHANGE COLUMN `RewardTitleId` `RewardTitle` TINYINT(3) UNSIGNED NOT NULL DEFAULT '0' AFTER `SpecialFlags`,
	CHANGE COLUMN `RewardItemId1` `RewardItem1` MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardArenaPoints`,
	CHANGE COLUMN `RewardItemId2` `RewardItem2` MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardItem1`,
	CHANGE COLUMN `RewardItemId3` `RewardItem3` MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardItem2`,
	CHANGE COLUMN `RewardItemId4` `RewardItem4` MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardItem3`,
	CHANGE COLUMN `RewardItemCount1` `RewardAmount1` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardItem4`,
	CHANGE COLUMN `RewardItemCount2` `RewardAmount2` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardAmount1`,
	CHANGE COLUMN `RewardItemCount3` `RewardAmount3` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardAmount2`,
	CHANGE COLUMN `RewardItemCount4` `RewardAmount4` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardAmount3`,
	CHANGE COLUMN `RewardChoiceItemCount1` `RewardChoiceItemQuantity1` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardChoiceItemId6`,
	CHANGE COLUMN `RewardChoiceItemCount2` `RewardChoiceItemQuantity2` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardChoiceItemQuantity1`,
	CHANGE COLUMN `RewardChoiceItemCount3` `RewardChoiceItemQuantity3` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardChoiceItemQuantity2`,
	CHANGE COLUMN `RewardChoiceItemCount4` `RewardChoiceItemQuantity4` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `RewardChoic/* duże zapytanie SQL (3,8 KiB), przycięte do 2 000 znaków */
