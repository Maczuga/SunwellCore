...
namespace MMAP
{
    ...
    bool MMapManager::loadMapData(uint32 mapId)
    {
        ...
        uint32 pathLen = sConfigMgr->GetStringDefault("DataDir", ".").length() + strlen("mmaps/%03i.mmap") + 1;
        char *fileName = new char[pathLen];
        snprintf(fileName, pathLen, (sConfigMgr->GetStringDefault("DataDir", ".") + "mmaps/%03i.mmap").c_str(), mapId);
    ...
    bool MMapManager::loadMap(uint32 mapId, int32 x, int32 y)
    {
        ...
        uint32 pathLen = sConfigMgr->GetStringDefault("DataDir", ".").length() + strlen("mmaps/%03i%02i%02i.mmtile") + 1;
        char *fileName = new char[pathLen];
        snprintf(fileName, pathLen, (sConfigMgr->GetStringDefault("DataDir", ".") + "mmaps/%03i%02i%02i.mmtile").c_str(), mapId, x, y);
